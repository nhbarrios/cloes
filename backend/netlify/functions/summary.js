...
//   totalClients = clientes distintos que compraron este mes
//   totalOrders  = pedidos hechos este mes
//   totalDebt    = saldo pendiente de esos pedidos de este mes
// (en ambos casos se ignoran los pedidos cancelados)
...
exports.handler = async (event) => {
  ...
  try {
    if (scope === 'month') {
      ...
      return json(200, { totalClients, totalOrders, totalDebt, scope: 'month', range: { start, end } });
    }
